...
if st.button('Obtener recomendaciones'):
    ...
    for idx, movie in enumerate(recommended_movies):
        if idx == 0:  # Marcar la película recomendada como "Top 1"
            col1, col2 = st.columns([3, 1])
            with col1:
                st.subheader(f"**{movie['title']}** (Top 1)")
        ...
        else:  # Mostrar el resto de las películas recomendadas con un estilo diferente
            col1, col2 = st.columns([3, 1])
            with col1:
